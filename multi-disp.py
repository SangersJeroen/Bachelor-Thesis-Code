...
if __name__ == '__main__':
    ...
    qmap_k, qaxis_k = mreels.pool_qmap(qmap_k, qaxis_k, 2)
    qmap_m, qaxis_m = mreels.pool_qmap(qmap_m, qaxis_m, 2)
    qmap_p, qaxis_p = mreels.pool_qmap(qmap_p, qaxis_p, 2)
    qmap_r, qaxis_r = mreels.pool_qmap(qmap_r, qaxis_r, 2)
